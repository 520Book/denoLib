// Requires BigInt.js.
// Copyright 2021-2022 Adong

export { cmdEncrypt as RSA }

const twoDigit = () => (n < 10 ? "0" : "") + String(n);
...
function cmdEncrypt(val) {
  setMaxDigits(129);
  var key = new RSAKeyPair('010001', '', '');
  var pwdRtn = encryptedString(key, val);
  return pwdRtn;
}